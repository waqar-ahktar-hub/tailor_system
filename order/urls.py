...
from order.views.order_views import order_add_view, order_detail_view, order_list_view, order_update_view,orders_with_pending_payments,header_top_view
...
urlpatterns = [
    ...
    path('orders/pending/', orders_with_pending_payments, name='pending_orders'),
    path('header/', header_top_view, name='header_top'),
    # TASK URLS
